...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Flash', "Value 1: Camera Flash\nValue 2: HUD Flash\n\nEvery value works as the following example: \"255, 127, 25\".\nThe first number (255) is red.\nThe second number (127) is green and \n the third number(25) is blue, duration is 1 second."],
		['Cinematics', "Used in Infernum and Vexation,\nValue 1: 1 = Turn ON,\nValue 2: 2 = Turn OFF"],
		['Infernum Glow', "Exclusive to Infernum\nValue 1: 0/1/2 = OFF/ON/Reset Gradient\n"],
		['Trigger Vine Mechanic', "Exclusive to Vexation\nA vine pops up and grabs BF. Bf becomes stunned until you press \n SPACE. BF uses his telekinesis so the vine disappears."],
